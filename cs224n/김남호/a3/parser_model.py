...
class ParserModel(nn.Module):
    ...
    def forward(self, t):
        ...
        # 으악
        a = self.embedding_lookup(t=t)
        layer1_1 = self.embed_to_hidden(a)
        layer1_2 = nn.functional.relu(layer1_1)
        layer1_3 = self.dropout(layer1_2)
        logits = self.hidden_to_logits(layer1_3)
        ### END YOUR CODE
        return logits
