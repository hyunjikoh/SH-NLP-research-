...
def pad_sents_char(sents, char_pad_token):
    ...
    '''
    empty_words = max_word_length * [char_pad_token]
    ...
    for s in sents:
        words_padded = []
        for w in s:
            words_padded.append(w + (max_word_length - len(w)) * [char_pad_token])
        sents_padded.append(words_padded + (max_len - len(words_padded)) * [empty_words])
    '''
